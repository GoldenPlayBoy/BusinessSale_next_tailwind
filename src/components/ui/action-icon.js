...
const classes = {
  base:
    "inline-flex items-center justify-center focus:outline-none transition duration-200 active:scale-95",
  size: {
    sm: "p-0.5 w-7 h-7",
    DEFAULT: "p-1 w-9 h-9",
    lg: "p-2 w-11 h-11",
  ...
  variant: {
    solid: {
      ...
      color: {
        ...
        info:
          "bg-blue hover:enabled:bg-blue-dark focus:ring-blue/30 text-white",
        success:
    ...
    flat: {
      ...
      color: {
        ...
        info:
          "bg-blue-lighter hover:enabled:bg-blue-dark/20 focus:ring-blue/30 text-blue-dark",
        success:
    ...
    outline: {
      ...
      color: {
        ...
        info:
          "hover:enabled:bg-blue-lighter/40 focus:ring-blue/30 text-blue-dark border-blue hover:enabled:border-blue-dark",
        success:
